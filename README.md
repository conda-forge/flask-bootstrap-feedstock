...
All platforms:
[![noarch](https://img.shields.io/circleci/project/github/conda-forge/flask-bootstrap-feedstock/master.svg?label=noarch)](https://circleci.com/gh/conda-forge/flask-bootstrap-feedstock)
...
Once the `conda-forge` channel has been enabled, `flask-bootstrap` can be installed with:

```
conda install flask-bootstrap
```

It is possible to list all of the versions of `flask-bootstrap` available on your platform with:
